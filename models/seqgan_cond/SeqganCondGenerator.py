...
class Generator(object):
    def __init__(self, num_vocabulary, batch_size, emb_dim, hidden_dim,
                 sequence_length, start_token, relevant_word_length,
        ...
        self.relevant_word_length = relevant_word_length
        ...
        self.y = tf.placeholder(tf.int32, shape=[self.batch_size, self.relevant_word_length]) # this is the conditional part, i.e. the relevant words

        self.xy = tf.concat(axis=1, values=[self.x, self.y])
        ...
        with tf.device("/cpu:0"):
            self.processed_x = tf.transpose(tf.nn.embedding_lookup(self.g_embeddings, self.xy),
        ...
        ta_emb_x = tensor_array_ops.TensorArray(
            dtype=tf.float32, size=self.sequence_length + self.relevant_word_length)
